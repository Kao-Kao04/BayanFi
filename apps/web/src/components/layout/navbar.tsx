      ...
      <div className="container flex h-16 items-center justify-between">
        <Link href="/" className="group flex items-center">
          ...
          <Image
            ...
            width={130}
            height={44}
            className="hidden dark:block h-9 w-auto object-contain transition-transform duration-300 group-hover:scale-105"
            priority
          />
          ...
          <Image
            ...
            width={130}
            height={44}
            className="block dark:hidden h-9 w-auto object-contain transition-transform duration-300 group-hover:scale-105"
            priority
          />
        </Link>
